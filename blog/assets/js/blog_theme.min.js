...
var config={disqus_shortname:"ECKODEV"};jQuery(document).ready(function(){"use strict";function e(e){return!("undefined"==typeof ecko_theme_config||!ecko_theme_config.hasOwnProperty(e)||""===ecko_theme_config[e])&&ecko_theme_config[e]}function o(){0===jQuery(".pagination a").length&&jQuery(".pagination").hide()}function t(){("Microsoft Internet Explorer"==navigator.appName||navigator.userAgent.match(/Trident/)||navigator.userAgent.match(/rv:11/)||void 0!==jQuery.browser&&1==jQuery.browser.msie)&&void 0!==svg4everybody()&&svg4everybody()}function r(){jQuery("pre code").each(function(e){void 0!==jQuery(this).attr("data-language")&&!1!==jQuery(this).attr("data-language")||jQuery(this).attr("data-language","generic")}),Rainbow.color()}function a(){jQuery(".postcontents, .format-video, .format-audio").fitVids()}function i(){e("social_instagram")&&(jQuery(".social-instagram").attr("href",e("social_instagram")),jQuery(".social-instagram").show()),e("social_github")&&(jQuery(".social-github").attr("href",e("social_github")),jQuery(".social-github").show()),e("social_linkedin")&&(jQuery(".social-linkedin").attr("href",e("social_linkedin")),jQuery(".social-linkedin").show())}function n(){document.querySelectorAll(".kg-gallery-image img").forEach(function(e){var o=e.closest(".kg-gallery-image"),t=e.attributes.width.value,r=e.attributes.height.value,a=t/r;o.style.flex=a+" 1 0%"})}function s(){e("disqus_id")&&jQuery(".comments").css("display","block")}function u(e,o){var t=document,r=t.createElement("script");r.src="https://"+ecko_theme_config.disqus_id+".disqus.com/embed.js",r.setAttribute("data-timestamp",+new Date),(t.head||t.body).appendChild(r)}function c(){e("google_analytics_id")&&jQuery.getScript("https://www.googletagmanager.com/gtag/js?id="+ecko_theme_config.google_analytics_id,function(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config",ecko_theme_config.google_analytics_id)})}function l(){jQuery("img").attr("data-no-retina","true"),jQuery("img.retina").removeAttr("data-no-retina","false")}function d(){if(jQuery(".cover").length>0?(jQuery(".headroom").css("display","none"),jQuery("footer.postinfo").css("display","none"),jQuery(".cover").waypoint(function(e){"down"==e&&jQuery(".headroom").css("display","block"),"up"==e&&jQuery(".headroom").fadeOut(200)},{offset:-Math.abs(jQuery(".cover").height())}),jQuery(".cover").waypoint(function(e){"down"==e&&jQuery("footer.postinfo").css("display","block"),"up"==e&&jQuery("footer.postinfo").fadeOut(200)},{offset:-75})):jQuery(".headroom").css("display","block"),jQuery(".headroom").length>0){Headroom.options.offeset=50,Headroom.options.tolerance.up=20,Headroom.options.tolerance.down=10,Headroom.options.onUpin=function(){jQuery(".sub-menu").slideUp()};var e=document.querySelector(".headroom");new Headroom(e).init()}}function y(){jQuery(".drawer").addClass("show"),jQuery(".pagewrapper").addClass("slide"),jQuery(".bloginfo").addClass("slide"),jQuery(".searchoverlay").addClass("slide"),jQuery("footer.postinfo").addClass("slide"),setTimeout(function(){jQuery(".pagewrapper").addClass("slide-completed")},500)}function f(){jQuery(".drawer").removeClass("show"),jQuery(".pagewrapper").removeClass("slide"),jQuery(".pagewrapper").removeClass("slide-completed"),jQuery(".bloginfo").removeClass("slide"),jQuery(".searchoverlay").removeClass("slide"),jQuery("footer.postinfo").removeClass("slide")}function p(){if(jQuery("body.post-template").length>0&&jQuery(window).width()>880&&"0.3"==jQuery(".cover").attr("data-opacity")){var e=jQuery(".cover"),o=jQuery(".cover").height();jQuery(window).resize(function(){e=jQuery(".cover"),o=jQuery(".cover").height()}),jQuery(window).on("scroll",function(){var t=jQuery(this).scrollTop();e.each(function(){var e=jQuery(this).offset().top;e+=jQuery(this).outerHeight()/1,jQuery(".cover .background").css({opacity:.3+(t-e+o)/(o/2)}),jQuery(".cover .posttitle").css({opacity:1-(t-e+o)/(o/4)})})})}}function m(){jQuery(".postcontents p").has('img[alt="full"]').each(function(){jQuery(this).addClass("full")}),jQuery(".postcontents p").has('img[alt="wide"]').each(function(){jQuery(this).addClass("wide")})}!function(){t(),l(),o(),r(),a(),s(),c(),d(),p(),m(),i(),n()}(),jQuery(".commentheader").on("click",function(){var e=jQuery(".postcomments").data("page-url"),o=jQuery(".postcomments").data("page-id");jQuery(".commentitems").css("display","block"),u(e,o),jQuery("html, body").animate({scrollTop:jQuery("#comments").offset().top},800),jQuery(".commenttitle").html(jQuery(".commenttitle").data("locale-comments"))});var j=jQuery(".subscribe-form");j.submit(function(e){if(""===jQuery(".subscribe-input").val())return void e.preventDefault();jQuery.ajax({type:j.attr("method"),url:j.attr("action"),data:j.serialize(),success:function(e){jQuery(".subscribe-submit").addClass("subscribe-submit__success"),jQuery(".subscribe-input").val("").attr("placeholder",jQuery(".subscribe-submit").data("success-input"))},error:function(e){}}),e.preventDefault()}),jQuery(document).on("click",".pagewrapper.slide-completed",function(){f()}),jQuery(".drawer-open").click(function(){jQuery(".drawer").hasClass("show")?f():y()}),jQuery(".drawer-close").click(function(){f()}),jQuery(".mouse").click(function(){jQuery("html, body").animate({scrollTop:jQuery(".cover").height()},1e3)}),jQuery(".backtotop").click(function(){jQuery("html, body").animate({scrollTop:0},600)}),jQuery(".postbottom").waypoint(function(e){"down"==e&&jQuery(".default").fadeOut(200,function(){jQuery(".postinfo .relatedposts").fadeIn(200)}),"up"==e&&jQuery(".postinfo .relatedposts").fadeOut(200,function(){jQuery(".default").fadeIn(200)})},{offset:"100%"}),jQuery(".showsocial").click(function(){jQuery("footer.postinfo .socialoptions").fadeToggle(200)}),jQuery(".closeshare").click(function(){jQuery("footer.postinfo .socialoptions").fadeOut(200)}),jQuery(".postcontents a").each(function(){jQuery(this).attr("href").match(/\.(jpg|png|gif|jpeg)/g)&&jQuery(this).magnificPopup({type:"image",closeOnContentClick:!0,fixedContentPos:!0,mainClass:"mfp-no-margins mfp-with-zoom",image:{verticalFit:!0},gallery:{enabled:!0},zoom:{enabled:!0,duration:300}})})});